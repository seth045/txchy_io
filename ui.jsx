...
const { motion, AnimatePresence, useScroll, useTransform, useMotionValue, useSpring: useSpringFM } = framerMotion;
...
/* ======================================================================
   MagneticCard — wraps any motion element with magnetic hover tracking
====================================================================== */
function MagneticCard({ as: As = motion.div, strength = 0.32, children, style, onMouseMove, onMouseLeave, ...rest }) {
  const ref = useRef(null);
  const mx = useMotionValue(0);
  const my = useMotionValue(0);
  const sx = useSpringFM(mx, { stiffness: 170, damping: 18, mass: 0.55 });
  const sy = useSpringFM(my, { stiffness: 170, damping: 18, mass: 0.55 });
...
window.TXCHY_UI = { Icon, SectionHeader, GradientButton, MagneticCard, motion, AnimatePresence };
